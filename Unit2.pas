...
begin
  ...
  valueNum1 := InputBox('Фильтрация по полю "Стоимость за занятие"', 'От: ', '');
  valueNum2 := InputBox('Фильтрация по полю "Стоимость за занятие"', 'До: ', '');
...
begin
  ...
  valueNum1 := InputBox('Фильтрация по полю "Количество учащихся"', 'От: ', '');
  valueNum2 := InputBox('Фильтрация по полю "Количество учащихся"', 'До: ', '');
